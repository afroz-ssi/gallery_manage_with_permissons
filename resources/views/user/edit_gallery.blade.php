        ...
        <main class="p-4 min-vh-100">
            <div class="jumbotron jumbotron-fluid rounded bg-white border-0 shadow-sm border-left px-4">
                <div class="container pb-5">
                    <h2 class="display-4 mb-2 text-primary">Update Gallery</h2>
                    <form method="post" action="{{ route('update_gallery') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gallery_name" id="gallery_name"
                                placeholder="User Name" value="{{ $gallery->gallery_name }}" required />
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gallery_type" id="gallery_type"
                                placeholder="Gallery Type" value="{{ $gallery->gallery_name }}" required />
                        ...
                        <br>
                        <div class="form-group">
                            <button class="btn btn-success btn-lg" type="submit" id="create_role">Update Gallery</button>
                        </div>
                    </form>
                </div>
            </div>
